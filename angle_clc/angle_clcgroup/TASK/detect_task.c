...
uint8_t error[ERROR_LIST_LENGHT + 1];
...
static void detect_init(uint32_t time)
{
    ...
    uint16_t set_item[ERROR_LIST_LENGHT][3] =
        {
            {10, 10, 11},   //ch_wheel_motor1
            {10, 10, 10},   //ch_wheel_motor2
            {10, 10, 9},    //ch_wheel_motor3
            {10, 10, 8},    //ch_wheel_motor4
            {10, 10, 11},   //ch_steer_motor1
            {10, 10, 11},   //ch_steer_motor2
            {10, 10, 11},   //ch_steer_motor3
            {10, 10, 11},   //ch_steer_motor4
            {2, 3, 7},      //board gyro
            {5, 5, 7},      //board accel
            {40, 200, 7},   //board mag
        };
